  ...
  <section id="methodology" class="mth-root" ref="sectionRef">
    ...
    <div class="mth-inner">
      ...
      <div class="mth-header" data-reveal>
        ...
        <h2 class="mth-title">{{ methodology?.title ?? 'Engagement Methodology' }}</h2>
        <p class="mth-subtitle">
          From first audit to continuous optimisation — our three-phase engagement model ensures every OT/IT integration is delivered with precision, backed by field-proven engineers, and built to evolve with your operations.
        </p>
      </div>
          ...
          <Transition name="mth-fade" mode="out-in">
            ...
            >
              ...
              <div class="mth-phase-row">
                <svg class="mth-phase-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              ...
              <ul class="mth-pane-list">
                <li v-for="bullet in activeData.bullets" :key="bullet" class="mth-pane-item">
...
const stageDetails = {
  1: {
    ...
    intro: 'We start by mapping the full picture — legacy systems, data flows, and integration gaps — then design a future-state architecture that bridges your OT and IT worlds.',
    bullets: [
  ...
  2: {
    ...
    intro: 'Our hybrid squads embed directly in your environment — commissioning hardware, building custom software, and running agile sprints to deliver working systems fast.',
    bullets: [
  ...
  3: {
    ...
    intro: 'Go-live is only the beginning. We stay engaged with proactive monitoring, software iteration, and data-driven tuning to keep your plant performing at its peak.',
    bullets: [
...
.mth-watermark svg { width: 100%; height: 100%; }
...
/* ── Skeleton ──────────────────────────────────────────────────────── */
.mth-skeleton { align-items: stretch; }
.mth-skel-tabs {
  display: flex;
  flex-direction: column;
  gap: 0.75rem;
