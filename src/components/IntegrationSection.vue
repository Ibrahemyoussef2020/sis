    ...
    <div class="mx-auto max-w-7xl">
      ...
      <div class="grid gap-8 lg:grid-cols-3">
        <div>
          ...
          <p class="mt-3 text-sm text-sis-muted" data-reveal>
          ...
          <div class="mt-6 space-y-4">
            <template v-if="loaded">
              <article
                ...
                :key="proj.client"
                class="rounded-xl border border-sis-border bg-white p-4 shadow-sis flex items-start gap-4"
              >
                <div
          ...
          <div class="mt-6 grid gap-3">
            <template v-if="loaded">
              <div
                v-for="s in sectors"
                :key="s.id"
                class="flex items-center gap-4 rounded-xl border border-sis-border bg-white p-3 w-full text-left"
              >
          ...
          <div class="mt-6 flex flex-wrap gap-2">
            <template v-if="loaded">
              <span
                ...
                :key="col"
                class="rounded-full bg-sis-primary/10 px-4 py-2 text-sm text-sis-primary"
                >{{ col }}</span
              >
            </template>
            <template v-else>
