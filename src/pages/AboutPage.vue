<template>
  <main class="bg-background text-on-background font-body-lg text-body-lg overflow-x-hidden pt-16 relative">
...
import AboutMissionVision from '@/components/about/AboutMissionVision.vue'
